            ...
            <div class="col-md-6">
                <div id="product-images">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active"> <img class="img_size" src="/product/<?php echo e($product->image); ?>"></div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="product-detail mt-6 mt-md-0">
                    <h1 class="mb-1" style="font-family: 'Montserrat'; font-weight: 700; font-size: 32px;"><?php echo e($product->title); ?></h1>
                    ...
                    <?php if($product->discount_price!=null): ?>
                        <h6 style="color: red; font-family: 'Montserrat'; font-weight: 500; font-size: 28;">
                          Rp <?php echo e(number_format($product->discount_price)); ?>
                        ...
                        <h6 style="color: black; font-family: 'Montserrat'; font-weight: 500; font-size: 28;">
                           Rp <?php echo e(nummber_format($product->price)); ?>
...
</html><?php /**PATH C:\xampp\htdocs\toko_online\resources\views/home/product_details.blade.php ENDPATH**/ ?>